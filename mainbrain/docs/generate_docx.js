    ...
    { properties: { page: { size: { width: 12240, height: 15840 } } },
      children: [
        ...
        table(["ID","Weakness","Severity","Realistic fix"],[
          ...
          ["W-02","CLOSED — tested-patch sandbox now enforced","Critical","Done: docking/improvement/sandbox.py, 15 tests"],
          ["W-03","Distributed runtime is single-node","Critical","Redis adapter behind the store interface"],
          ["W-04","CLOSED — swarm typechecks clean in CI","High","Done: tsc --noEmit exits 0, blocking gate"],
          ["W-05","CLOSED — live CI gating both suites","High","Done: .github/workflows/mainbrain-ci.yml"],
          ...
          ["W-08","Path centralization unfinished","Medium","Migrate 48 pending files to core.paths"],
          ...
          ["W-11","Swarm install not reproducible","Medium","Pin ajv-formats via overrides; npm ci rejects the lockfile"],
        ],[900,3900,1500,4500]),
        spacer(),
        H2("Roadmap — the gate chain is a real sequence"),
        table(["Phase","What","Gate","Status"],[
          ["0","CI + build proof","mainbrain-ci.yml","Done"],
          ["1","Cryptographic binding","SPEC-CRYPTOGRAPHIC_BINDING","Done"],
          ["2","Deploy proof gate","SPEC-DEPLOY_PROOF_GATE","Done"],
          ["3","Tested patch sandbox","SPEC-TESTED_PATCH_EXECUTION_SANDBOX","Done"],
          ["4","Distributed worker plane","redis adapter","Next"],
